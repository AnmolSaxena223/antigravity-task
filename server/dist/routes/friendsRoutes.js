...
router.get('/requests', friendsController.getPendingFriendRequests);
router.get('/search', friendsController.searchFriend);
router.get('/blocked', friendsController.getBlockedList);
