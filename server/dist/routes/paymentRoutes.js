...
router.post('/create-order', auth_1.authenticateJWT, rateLimiter_1.apiLimiter, validation_1.validateDeposit, paymentController.createOrder);
router.post('/verify', auth_1.authenticateJWT, rateLimiter_1.apiLimiter, paymentController.verifyPayment);
